...
day_df = pd.read_csv('https://raw.githubusercontent.com/devitaindhas/bike-sharing-data-analysis/blob/main/dashboard/new_day.csv')
hour_df = pd.read_csv('https:/raw.githubusercontent.com/devitaindhas/bike-sharing-data-analysis/blob/main/dashboard/new_hour.csv')
